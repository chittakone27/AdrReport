...
const Reporter = ({ orgUnitId, startDate, endDate }) => {
  // const { auth } = useAuth();
  ...
  useEffect(() => {
    ...
    const url = `https://dhis2.asia/laotracker/api/29/analytics/events/aggregate/AQBx2QVBvRH.json?dimension=ou:${orgUnitId}&dimension=d3iJyrWjNUy.LN622u9POha&stage=d3iJyrWjNUy&startDate=${startDate}&endDate=${endDate}&displayProperty=NAME&totalPages=false&outputType=EVENT`;
